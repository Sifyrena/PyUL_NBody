...
D_version = str('2020 10 22, NBody with Noncentralized Dynamical Evaluation')
...
def evolve(save_path,run_folder):
    ...
    # For Compatibility Safety Only. The 2 following lines do not do anything.
