...
def evolve(central_mass, num_threads, length, length_units, resol, duration, duration_units, step_factor, save_number, save_options,
    ...
    if Uniform:
        ...
        print('==============================================================================')
        print(f"PyUL Init: Solitons overridden with a uniform wavefunction with no phase.")
        print(f"PyUL Init: Total ULDM mass in domain is {MassCom:.4f}. This is {Density:.4f} per grid.")
        print('==============================================================================')
